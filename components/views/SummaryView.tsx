  ...
  return (
    <div className="space-y-6">
      <Section title="Resumen Ejecutivo">
        <p className="text-gray-200">{data.executive_summary}</p>
      </Section>
        ...
        {data.decisions.length > 0 ? (
          <div className="space-y-3">
            {data.decisions.map((d, index) => (
              <Card key={index}>
                <p className="font-semibold text-gray-100">{d.decision}</p>
        ...
        {data.risks.length > 0 ? (
          <div className="space-y-3">
            {data.risks.map((r, index) => (
              <Card key={index}>
                <p className="font-semibold text-gray-100">{r.risk}</p>
                 <p className="text-sm text-gray-400">
                  Impacto: {r.impact}
                </p>
